        ...
        return $form
            ->schema([
                Forms\Components\Section::make([
                    ...
                    Forms\Components\Select::make('type')->native(false)->options(PetType::class)->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([               
                ...
                Tables\Columns\TextColumn::make('date_of_birth')->date('M d Y')->sortable()->searchable(),
